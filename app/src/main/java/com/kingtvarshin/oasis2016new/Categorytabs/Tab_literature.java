package com.kingtvarshin.oasis2016new.Categorytabs;
...
public class Tab_literature extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) rootView.findViewById(R.id.card_recycler_view_tab19);
            ...
            try {
                ...
                for (int i=0; i<parentArray.length(); i++){
                    ...
                    for (int j=0; j<finalArray.length(); j++){
                        ...
                        if(finalObject.getInt("id")%5 + 19 == 19 ) {
