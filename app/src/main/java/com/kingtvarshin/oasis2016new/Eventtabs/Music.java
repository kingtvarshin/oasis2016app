...
public class Music extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView) v.findViewById(R.id.card_recycler_view_musictab);
...
//        RecyclerView.LayoutManager layoutManager = new StaggeredGridLayoutManager(2,StaggeredGridLayoutManager.VERTICAL);
        ...
        mRef2 = new Firebase("https://oasis-81d10.firebaseio.com/event/Description/music");
...
//        eventdesc.add("Razzmatazz*");
        ...
        mRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                String value = dataSnapshot.getValue(String.class);
                eventtitle.add(value);
                Log.v("array list of Music", eventtitle.toString());
                adapter.notifyDataSetChanged();
            }
