...
//        setTitle("About");
        ...
        View v =inflater.inflate(R.layout.tab_drama,container,false);

        RecyclerView recyclerView = (RecyclerView) v.findViewById(R.id.card_recycler_view_dramatab);
...
//        RecyclerView.LayoutManager layoutManager = new StaggeredGridLayoutManager(2,StaggeredGridLayoutManager.VERTICAL);
        ...
        mRef2 = new Firebase("https://oasis-81d10.firebaseio.com/event/Description/Drama");
...
//        eventdesc.add("Razzmatazz*");
        ...
        mRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                String value = dataSnapshot.getValue(String.class);
                eventtitle.add(value);
                Log.v("array list of drama", eventtitle.toString());
                adapter.notifyDataSetChanged();
            }
