...
public class Online extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v =inflater.inflate(R.layout.tab_online,container,false);

        RecyclerView recyclerView = (RecyclerView) v.findViewById(R.id.card_recycler_view_onlinetab);
...
//        eventdesc.add("Razzmatazz*");
        ...
        mRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                String value = dataSnapshot.getValue(String.class);
                eventtitle.add(value);
                Log.v("array list of Online", eventtitle.toString());
                adapter.notifyDataSetChanged();
            }
