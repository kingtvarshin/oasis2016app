...
public class Tab_21 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.tab_21, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.card_recycler_view_tab21);
            ...
            try {
                ...
                for (int i=0; i<parentArray.length(); i++){
                    ...
                    for (int j=0; j<finalArray.length(); j++){
                        ...
                        if(finalObject.getInt("id")%5 + 19 == 21 ) {
